...
<form name="frm" action="/stics/rank" method="get">
<ul>
	<li>
		<b>[INPUT PARAMS]</b>
		대상날짜 : <input type="text" pattern="[0-9]+" name="target_date" value="${target_date}" style="width: 80px;"/> |
